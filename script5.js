...
let hasAnswered = false; // 현재 문제에 답변했는지 여부
...
function showQuestion() {
    resetState();
    hasAnswered = false; // 새 문제로 넘어갈 때 답변 여부 초기화
...
function selectAnswer(e) {
    if (hasAnswered) return; // 이미 답변했다면 추가 클릭 방지
